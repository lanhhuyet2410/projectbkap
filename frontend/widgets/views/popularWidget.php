                ...
                <ul class="aa-product-catg aa-popular-slider">
                  ...
                  <li>
                    <figure>
                      ...
                      <a class="aa-add-card-btn" href="javascript:void(0)" onclick="addCart(<?= $value1['product_id'] ?>)"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                       <figcaption>
                    ...
                    <div class="aa-product-hvr-content">
                      ...
                      <a href="#" data-toggle2="tooltip" class="quick-view" data-id="<?= $value1['product_id'] ?>" data-placement="top" title="Quick View" data-toggle="modal" data-target="#quick-view-modal"><span class="fa fa-search"></span></a>                            
                    </div>
                    <!-- product badge -->
                    <?php 
                      if ($value1['saleoff']>0) {
               ...
               <ul class="aa-product-catg aa-featured-slider">
                  ...
                  <li>
                    <figure>
                      ...
                      <a class="aa-add-card-btn" href="javascript:void(0)" onclick="addCart(<?= $value2['product_id'] ?>)"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                       <figcaption>
                    ...
                    <div class="aa-product-hvr-content">
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Compare"><span class="fa fa-exchange"></span></a>
                      <a href="#" data-toggle2="tooltip" class="quick-view" data-id="<?= $value2['product_id'] ?>" data-placement="top" title="Quick View" data-toggle="modal" data-target="#quick-view-modal"><span class="fa fa-search"></span></a>                            
                    </div>
                    <!-- product badge -->
                    <?php 
                      if ($value2['saleoff']>0) {
                ...
                <ul class="aa-product-catg aa-latest-slider">
                  ...
                  <li>
                    <figure>
                      ...
                      <a class="aa-add-card-btn" href="javascript:void(0)" onclick="addCart(<?= $value3['product_id'] ?>)"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                       <figcaption>
                    ...
                    <div class="aa-product-hvr-content">
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Compare"><span class="fa fa-exchange"></span></a>
                      <a href="#" data-toggle2="tooltip" class="quick-view" data-id="<?= $value3['product_id'] ?>" data-placement="top" title="Quick View" data-toggle="modal" data-target="#quick-view-modal"><span class="fa fa-search"></span></a>                            
                    </div>
                    <!-- product badge -->
                    <?php 
                      if ($value3['saleoff']>0) {
