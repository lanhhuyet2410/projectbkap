            ...
            <ul class="aa-product-catg">
              ...
              <li>
                <figure>
                  ...
                  <a href="javascript:void(0)" class="aa-add-card-btn quick-view" data-toggle="modal" data-target="#quick-view-modal" data-id="<?= $value['product_id'] ?>"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                  <figcaption>
