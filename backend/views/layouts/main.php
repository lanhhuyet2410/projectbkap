    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= Yii::$app->urlManager->baseUrl ?>"><span>hoang</span>anh</a>
                <ul class="user-menu">
                    <li class="dropdown pull-right">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li>
                                <?php echo Html::a('<svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> Logout',['/site/logout'],['data-method'=>'post']); ?>
